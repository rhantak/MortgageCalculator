...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int principal = inputPrincipal();

        double monthlyInterest = inputAnnualInterest() / MONTHS_IN_YEAR / NUM_TO_PERCENT;

        int mortgageMonths = inputMortgagePeriod() * MONTHS_IN_YEAR;
    ...
    public static int inputPrincipal() {
    ...
    public static double inputAnnualInterest() {
        Scanner scanner = new Scanner(System.in);
    ...
    public static int inputMortgagePeriod() {
        Scanner scanner = new Scanner(System.in);
